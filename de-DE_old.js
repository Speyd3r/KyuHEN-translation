export default {
	...
	pages: {
		...
		details: {
			...
			process: {
				title: 'Der Ablauf',
				content: 'Der Wettbewer findet in 3 einfachen Schritten statt:',
				step1:
					'Jeder Teilnehmer sendet seine Projekte in eine der 4 Kategorien ein. Der Wettbewerb dauert 2 Monate, vom 27. März bis zum 27. Mai.',
				step2:
					'Die Jury wird jedes Projekt beurteilen und ihre eigene Bewertung dazu abgeben. Wir werden all Bewertungen zusammenfassen yu einer Gesammtrangliste.',
				step3:
					'Der Prize Pool wird so aufgeteilt wie in der Presiverteilungsgrafik die du im Regeln und Info Teil findest',
			},
			categories: {
